...
class Deck():
    ...
    def dealCards(self,deck,noOfCards,noOfHands):
        hands=[]
        allCards = False
        if noOfCards == 0:
    ...
    # the hand.
    def playACard(self,hand,cardToPlay):
    ...
    def isPlayingACard(self,hand,cardToPlay):
        played = False
    ...
    def convertFacesToNumbers(self,hand):
        for counter in range(0,len(hand)):
            hand[counter] = self.convertFaceToNumber(hand[counter])
    ...
    def convertNumbersToFaces(self,hand):
        for counter in range(0,len(hand)):
            hand[counter] = self.convertNumberToFace(hand[counter])
    ...
    def sortHand(self,hand):
        self.convertFacesToNumbers(hand)
        hand.sort()
        self.convertNumbersToFaces(hand)
